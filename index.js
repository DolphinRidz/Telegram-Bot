...
const token = "7681135552:AAG9wA0KT_kBEJfrrvcoTQF9jJXZ9REbVtI";
...
bot.on("message", async (msg) => {
  ...
  try {
    const response = await axios.get(
      `https://api.openweathermap.org/data/2.5/weather?q=${userInput}&appid=47dfa7c237c17392bf0e376fafb6a724`
    );
